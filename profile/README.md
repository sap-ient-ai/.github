...
We are a hub for freestyle exploration (theory) / engineering (code) of intelligent systems.
...
- (***Bojan***)              Full Spectrum research, Alignment, Recursive Self Improvement
- (***CatId***)               LLM architecture, local deployment, fine-tuning
- (***BeeGass***)         SSM innovations
- (***[GreyGoo](https://www.rey.wiki/george)***)        CUDA kernels, physics, philosophy
- (***Hong***)               Research / mathy things
- (***Buttercutter***) Neuromorphic / Quantum
- (***Alexey***)              General smarts and sanity
...
# 🚀 ❤️
Last updated by ***grey*** on 20 September 2026
